...
function HealthWorkerReferrals({ onBack, prefillPatient }) {
  ...
  const submitReferral = () => {
    ...
    if (!hospital || !reason) {
      alert(
        'Please enter hospital and referral reason.'
      )
      return
    }
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center px-6">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-xl border border-green-100 p-8 text-center">
          ...
          <p className="text-gray-500 mt-2">
            The hospital referral has been added to the patient's care journey.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  A referral follow-up task has been added for this patient.
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        <section className="bg-white rounded-3xl border border-blue-100 shadow-sm p-7 mt-6">
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold mt-6 flex items-center justify-center gap-2"
          >
            <FileText size={20} />
            Create Referral
          </button>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-orange-700 mt-1">
                Once this referral is created, SevaCare automatically
                creates a follow-up task so the patient is not lost
                after referral.
              </p>
            </div>
          </div>
